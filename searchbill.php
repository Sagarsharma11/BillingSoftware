    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-5 border py-5 px-5 mx-auto rounded">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Search Through Invoice</label>
                    <form action="searchbill.php" method="POST">
                        <input class="form-control" value="<?php echo $_GET['UID']; ?>" type="search" name="search" placeholder="Search" aria-label="Search">
                        <div class="col-sm-4 mx-auto">
                            <button class="btn btn-outline-primary  my-3" name="searchinvoice" type="submit">Search</button>
        ...
        <a href="invoice2.php?id=<?php echo $id; ?>" class="btn btn-primary "> INVOICE</a>
